...
public class  Todo extends AppCompatActivity {
    ...
    String Ownername, shareid, shareuser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent i = getIntent();
        String da = new SimpleDateFormat("yyyy-MM-dd", Locale.ENGLISH).format(new Date());
        if (i.hasExtra("notification")) {
            //str =   "select * from commontask where commontask_status='0' and date(commontask_reminder) = '"+da+"' order by commontask_reminderdatetime asc";
            task_id = i.getIntExtra("notificationid", 0);
            showtodo();
            showdialog();
    ...
    public void showtodo() {
        ...
        str = "select * from commontask where commontask_status='0' order by _id desc";
        ...
        homelist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, final View view, int position, long id) {
                ...
                if (type.equals("Groceries")) {
                    Intent i = new Intent(Todo.this, Groceri_List_dialog.class);
                    ...
                    if (flag == 2) {
                        if (sharcount == co) {
                            ...
                            if (sharcount > 0) {
                                ...
                                text4.setText("Task share with : Self");
                                showname = 0;
                            }
                        }
                    } else {
    ...
    public class MyCursorAdapter extends CursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
            ...
            ImageView imgshare = (ImageView) view.findViewById(R.id.share);

            String type = (cursor.getString(cursor.getColumnIndex(DatabaseHandler.TAG_COMMONTASKTYPE)));
            String owner = (cursor.getString(cursor.getColumnIndex(DatabaseHandler.TAG_COMMONTASKOWNERID)));
