...
public class Medicine extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(" M E D I C I N E ");
        ...
        if (c.getCount() == 0) {
            ...
            if (extras != null) {
                ...
                if (task.equals("Add Medicines")) {
                    Intent i = new Intent(Medicine.this, MainActivity.class);
                    i.addCategory(Intent.CATEGORY_HOME);
                    i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(i);
                } else {
                    Intent i = new Intent(Medicine.this, AddMedicines.class);
                    i.addCategory(Intent.CATEGORY_HOME);
                    i.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                    startActivity(i);
                }
        ...
        homelist.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                final Dialog dialog = new Dialog(Medicine.this);
                ...
                text.setText("Medicine set for : " + name);
    ...
    public class MyCursorAdapter extends CursorAdapter {
        ...
        public void bindView(View view, Context context, Cursor cursor) {
         ...
         /*   String type = cursor.getString(cursor.getColumnIndex(DatabaseHandler.TAG_TASKTYPE));
            ...
            img1.setImageResource(R.drawable.medicine_icon);
