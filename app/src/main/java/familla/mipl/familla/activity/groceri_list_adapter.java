...
public class groceri_list_adapter extends BaseAdapter {
    ...
    public groceri_list_adapter(Context applicationContext, String[] event) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.groceries_list, null);
